<?php
/**
 * Class to demonstrate an API interface.
 *
 *  Note this is a demo. We don't do request to API.
...
class VacancyApi {
    ...
    public static function initialize() {
        if (empty(self::$vacancies)) {
            self::$vacancies =[
                1 => (object)['id' => 1, 'title'=>'API Vacancy 1', 'content' => 'Lori ispsum blaa blaa'],
                2 => (object)['id' => 2, 'title'=>'API Vacancy 2', 'content' => 'Lori ispsum blaa blaa']
            ];
        }
    }
